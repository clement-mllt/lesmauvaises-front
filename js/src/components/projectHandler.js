      ...
      cards.forEach((card, index) => {
        cards.forEach((card, index) => {
          card.addEventListener("mouseenter", () => {
            // Faire bouger toutes les cartes après l'index de la carte survolée
          ...
          card.addEventListener("mouseleave", () => {
            // Réinitialiser les cartes après l'index à leur position d'origine définie par la boucle SCSS
            cards.forEach((otherCard, otherIndex) => {
